                                ...
                                <div className="w-1/4 pl-4">
                                    <div className="flex justify-between items-center search-wrapper rounded-full border-2 border-yellow-500 h-10">
                                        <div className="flex justify-start items-center">
                                            <div className="px-4 -mr-1 h-10 flex justify-between items-center text-white rounded-l-full bg-primary cursor-pointer hover:bg-secondaray">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                                                </svg>
                                            </div>
                                            <div className="px-4">
                                                <small>10 ITEM(S) - <span className="text-red-500 font-bold">$50.00</span></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
